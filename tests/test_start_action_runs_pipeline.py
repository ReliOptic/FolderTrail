...
class StartActionRunsPipelineTests(unittest.TestCase):
    def test_issue_85_prompt_wires_consent_to_run_model(self):
        ...
        self.assertIn("await runModel.run(prompt: prompt, sourceFolderURL: selectedFolderURL)", prompt)
        ...
        smoke = textwrap.dedent(
            ...
            struct Smoke {
                static func main() async throws {
                    ...
                    let model = FolderTrailPromptRunModel(runPipeline: { prompt, sourceURL in
                    ...
                    let failing = FolderTrailPromptRunModel(runPipeline: { _, _ in
