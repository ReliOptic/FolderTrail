...
class SafeExecutorBehaviorTests(unittest.TestCase):
    def test_issue_11_safe_executor_behavior(self):
        ...
        self.assertIn("trail.json", source)
        ...
        smoke = textwrap.dedent(
            ...
            expect(FileManager.default.fileExists(atPath: workspace.appendingPathComponent("trail.json").path), "trail.json should be written")
